...
link:architectures-plan-file-system.html["Planen Sie das Dateisystem"^]Erstellen Sie `group_vars/stor_<ID>.yml` für jeden Storage-Service im Cluster eine Datei unter, und füllen Sie sie wie folgt aus, um auf den  Abschnitt Bezug zu nehmen:
