...
NOTE: Die richtige Größe finden Sie unter link:beegfs-deploy-recommended-volume-percentages.html["Empfohlene Prozentsätze für die Überprovisionierung von Storage-Pools"] ..
