...
NOTE: Wenn Sie auf BeeGFS v8 aktualisieren, beachten Sie stattdessen das link:clusters-upgrade-beegfs-v8.html["Upgrade auf BeeGFS v8"] Verfahren.
...
| 7.4.6 | 8,0 | Ja. | Führen Sie das Upgrade gemäß den Anweisungen in der link:clusters-upgrade-beegfs-v8.html["Upgrade auf BeeGFS v8"]-Prozedur durch. 


| 7.4.6 | 8,1 | Ja. | Führen Sie das Upgrade gemäß den Anweisungen in der link:clusters-upgrade-beegfs-v8.html["Upgrade auf BeeGFS v8"]-Prozedur durch. 


| 7.4.6 | 8,2 | Ja. | Führen Sie das Upgrade gemäß den Anweisungen in der link:clusters-upgrade-beegfs-v8.html["Upgrade auf BeeGFS v8"]-Prozedur durch. 
|===
